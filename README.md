...
- 전투 단계는 1단계부터 100단계까지 진행됩니다.
- 단계가 오를 때마다 캐릭터의 최대 에너지, 공격, 방어, 이동 속도, 파워, 스페셜 게이지가 조금씩 계속 강화됩니다.
...
- 지역은 100단계 진행에 맞춰 초원, 사막, 빙하, 우주, 성운, 코어 순서로 확장됩니다.
- 지역별 점수 구간이 길게 설정되어 각 지역을 충분히 플레이한 뒤 보스가 등장합니다.
- 보스를 처치하면 3개 랜덤 보상 중 하나를 선택할 수 있습니다.
- 10단계마다 보스가 등장하며, 보스전은 일반 적이 사라지고 보스만 남습니다.
