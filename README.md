...
- Choose a unit before the game starts: Tank, Jet, Rover, or Ship
...
- Collect orange missile items for burst shots
- Collect blue shield items for temporary protection
...
- Higher levels add jump pads, teleport portals, and moving obstacles
